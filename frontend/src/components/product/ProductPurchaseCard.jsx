  ...
  return (
    <Card className="flex flex-col gap-4">
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500">Delivery availability coming soon</p>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          className="w-16 rounded-md border border-gray-300 px-2 py-1 text-sm disabled:opacity-50 dark:border-gray-700 dark:bg-transparent"
        />
      </div>
