...
const BENEFITS = [
  { icon: FiUsers, title: 'Reach More Customers', desc: 'Tap into a growing US marketplace audience.' },
...
export default function BecomeSellerHero() {
  return (
    <div className="rounded-xl bg-gradient-to-br from-primary-700 to-neutral-900 p-8 text-white sm:p-12">
      <h1 className="max-w-lg text-3xl font-bold text-balance sm:text-4xl">Start selling on Marketplace</h1>
